...
| F2_giro_contributivo_ips_2020_2026.xlsx | ADRES vía Así Vamos en Salud | Giro directo contributivo por EPS, IPS (NIT) y mes | 2020-01 a 2026-04 | Flujo de pagos contributivo |
...
| F3_bdua_contributivo.csv, F3_bdua_subsidiado.csv | Datos abiertos (BDUA) | Afiliados por EPS, régimen, departamento, municipio y grupo (corte único, sin fecha en el archivo) | corte 2026 (registrar fecha) | Denominador territorial |
...
| F4_reps_prestadores.csv | MinSalud, REPS | NIT, nombre, departamento y municipio de cada prestador | corte actual | Asigna departamento a cada IPS del giro directo |
